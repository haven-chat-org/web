...
import type { ChannelMemberInfo, UserProfileResponse } from "@haven-chat-org/core";
      ...
      <div className="member-sidebar-content">
        ...
        <div className="dm-member-sidebar-actions">
          <button
            className="btn-ghost"
            style={{ width: "100%" }}
            onClick={() => useUiStore.getState().openExportModal({ type: "dm", id: channelId })}
          >
          ...
          <button
            ...
            onClick={() => useUiStore.getState().openAttachmentsModal({ type: "dm", id: channelId })}
          >
